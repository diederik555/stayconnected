...
public class MySQLiteHelperBluetooth extends SQLiteOpenHelper {
  ...
  public MySQLiteHelperBluetooth(Context context) {
  ...
  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
    Log.w(MySQLiteHelperBluetooth.class.getName(),
